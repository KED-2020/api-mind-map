...
namespace :queues do
  ...
  task :create => :config do
    ...
    q_url = @sqs.get_queue_url(queue_name: @api.config.SUBSCRIPTIONS_QUEUE).queue_url
    puts 'Queue created:'
    puts "  Name: #{@api.config.SUBSCRIPTIONS_QUEUE}"
  ...
  task :purge => :config do
    ...
    puts "Queue #{@api.config.SUBSCRIPTIONS_QUEUE} purged"
  rescue StandardError => e
